...
<body>
    <a class="btn btn success" href="../tablas/t_usu.php" style="margin-left: 3.6%; margin-top:3%; position:relative;">  
        ...
        ?>
            ...
            <tr>
                ...
                <td style="background-color:#fff; padding-right:0%; padding-left:2.5%;"><?php $generator = new Picqer\Barcode\BarcodeGeneratorHTML();
                    echo $generator->getBarcode($usu['documento'], $generator::TYPE_CODE_128); ?></td>    
                <td><?= $usu['documento'] ?></td>
