...
$SQL = $conex->prepare ("SELECT*FROM ejercicio");
$SQL -> execute();
$resul=$SQL->fetchAll();
?>
...
<head>
    ...
    <title>Imprimir Ejercicio</title>
    <link href="../../../img1/logo9.png" rel="icon">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.3/font/bootstrap-icons.css">
</head>

<body>
    <a class="btn btn success" href="../tablas/tabla_ejerci.php" style="margin-left: 3.6%; margin-top:3%; position:relative;">  
        ...
        ?>
            ...
            <tr>
                ...
                <td style="background-color:#fff; padding-right:0%; padding-left:2.5%;"><?php $generator = new Picqer\Barcode\BarcodeGeneratorHTML();
                    echo $generator->getBarcode($ejer['id_ejercicio'], $generator::TYPE_CODE_128); ?></td>    
                <td><?= $ejer['id_ejercicio'] ?></td>
                <td><?= $ejer['nom_ejercicio'] ?></td>
