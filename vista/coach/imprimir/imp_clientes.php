...
<body>
    <a class="btn btn success" href="../tablas/t_cliente.php" style="margin-left: 3.6%; margin-top:3%; position:relative;">  
        ...
        ?>
            ...
            <tr>
                ...
                <td style="background-color:#fff; padding-right:0%; padding-left:2.5%;"><?php $generator = new Picqer\Barcode\BarcodeGeneratorHTML();
                    echo $generator->getBarcode($cli['documento'], $generator::TYPE_CODE_128); ?></td>    
                <td><?= $cli['documento'] ?></td>
                <td><?= $cli['nom_completo'] ?></td>
