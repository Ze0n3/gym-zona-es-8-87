                            ...
                            <div class="p-5">
                                ...
                                <form class="user">
                                    <div class="form-group row">
                                        ...
                                        <label>Edad</label>
                                            <input type="number" class="form-control form-control-user"
                                                id="exampleLastName" name="edad" maxlength="2"
                                                oninput="maxlengthNumber(this);" value="<?php echo $queryi['edad'] ?>">
                                        </div>
                                        <div class="col-sm-4"><br>
                                        <label>Genero</label>
                                        ...
                                        <label>Correo electronico</label>
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleLastName" name="correo" maxlength="35" oninput="validarletras(this);" onkeypress="return(sololetrasco(event));" value="<?php echo $queryi['correo'] ?>">
                                        </div>
                                        <div class="col-sm-4">
