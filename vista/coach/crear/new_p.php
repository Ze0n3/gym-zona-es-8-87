                            ...
                            <form class="user" name="user" method="post" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control" id="exampleLastName" name="nombre" maxlength="15" oninput="validarletras(this);" onkeypress="return(sololetras(event));"
                                        >
                                    </div>
                                    <br>
                                    <div class="col-sm-6">
                                    <label class="label">Codigo del Producto</label>
                                        <input type="text" id="randomNumberInput"  name="randomNumber" class="form-control">
                                            <script>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="exampleFirstName" name="canti"
                                        maxlength="3" oninput="maxlengthNumber(this);"  >
                                    </div>
                                    <br>
                                    <div class="col-sm-6 mb-9 mb-sm-0">
                                        <label class="label">Valor de Producto</label>
                                        <input type="number" class="form-control" id="exampleLastName" name="valor" maxlength="7" oninput="maxlengthNumber(this);"
                                        >
                                </div>
                            ...
                            <hr>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <button class="bi bi-chevron" style="padding:10px 14px 10px 10px; color:#fff; font-size:15px; background-color:#0d6efd; border-radius:10px;">Generar Codigo</button><br>
                                    </div>
                                </div>
                    </div>
                </div>
