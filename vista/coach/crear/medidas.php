                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="number" class="form-control " id="exampleFirstName" name="pecho"
                                            placeholder="Pecho" maxlength="4" oninput="maxlengthNumber(this);">
                                    </div>
                                    <br>

                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label class="label">Cintura</label>
                                        <input type="number" class="form-control" id="exampleFirstName" name="cintura"
                                            placeholder="Cintura" maxlength="4" oninput="maxlengthNumber(this);">
                                    </div>
                                    <br>

                                    <div class="col-sm-6">
                                        <label class="label">Cadera</label>
                                        <input type="number" class="form-control" id="exampleLastName" name="cadera"
                                            placeholder="Cadera" maxlength="4" oninput="maxlengthNumber(this);">
                                    </div>
                                    <br>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control" id="exampleFirstName" name="brazo_izq"
                                            placeholder="Brazo izquierdo" maxlength="4" oninput="maxlengthNumber(this);">
                                    </div>
                                    <br>
                                    <div class="col-sm-10" style="margin-bottom:12px;">
                                        ...
                                        <input type="text" class="form-control" id="exampleLastName" name="brazo_der" 
                                            placeholder="Brazo derecho" maxlength="4" oninput="maxlengthNumber(this);">
