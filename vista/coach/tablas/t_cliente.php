...
$sql1 = $conex->prepare("SELECT * FROM usuarios INNER JOIN tip_user ON usuarios.tipo_usuario = tip_user.id_tip_user INNER JOIN genero ON usuarios.genero=genero.id_genero INNER JOIN estado ON usuarios.estado=estado.id_estado WHERE usuarios.tipo_usuario = 3 ORDER BY documento LIMIT $empieza, $por_pagina");
$sql1->execute();
    ...
    <a class="btn btn success" href="../excel/excel_clientes.php" style="margin-left: 90%; margin-top:0%;">
        ...
        |<div class="text-center" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group me-2" role="group" aria-label="First group" aling>
                ...
                echo "<a href='t_cliente.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>"
                    . "</a></center>";
                ?>
            </div>
        </div>
