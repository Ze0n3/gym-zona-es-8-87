...
<body>
    <a class="btn btn success" href="../tablas/tabla_datos.php" style="margin-left: 3.6%; margin-top:3%; position:relative;">  
        ...
        ?>
            ...
            <tr>
                ...
                <td style="background-color:#fff; padding-right:0%; padding-left:2.5%;"><?php $generator = new Picqer\Barcode\BarcodeGeneratorHTML();
                    echo $generator->getBarcode($dat['id_datos'], $generator::TYPE_CODE_128); ?></td>    
                <td><?= $dat['id_datos'] ?></td>
                <td><?= $dat['datos'] ?></td>
