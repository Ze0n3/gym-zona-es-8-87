...
<head>
    ...
    <title>Imprimir Genero</title>
    <link href="../../../img1/logo9.png" rel="icon">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.3/font/bootstrap-icons.css">
</head>

<body>
    <a class="btn btn success" href="../tablas/genero.php" style="margin-left: 3.6%; margin-top:3%; position:absolute;">  
        ...
        ?>
            ...
            <tr>
                ...
                <td style="background-color:#fff; padding-right:0%; padding-left:2.5%;"><?php $generator = new Picqer\Barcode\BarcodeGeneratorHTML();
                    echo $generator->getBarcode($gen['id_genero'], $generator::TYPE_CODE_128); ?></td>    
                <td><?= $gen['id_genero'] ?></td>
                <td><?= $gen['genero'] ?></td>
