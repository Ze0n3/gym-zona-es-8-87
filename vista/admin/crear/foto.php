...
if (isset($_POST["btn-crear"])) {
   ...
   $consulta = $conex->prepare("UPDATE usuarios SET foto = '$foto' WHERE documento = '".$_SESSION['docu']."' ");
   $consulta->execute();
         ...
         <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
               <div class="row">
                  <div class="col-lg-10">
                     <div class="p-5">
                        <img src="../../../img/agregar.png" style="width:16%; margin-top:12%; margin-left:56%;"></img>
                        <div style="margin-top:8%; color:#fff; widht:22%; font-size:25px;">Añadir imagen:<br><br>
                           <input name="imagen" class="sele" id="archivo" type="file"/><br>
                           <input type="submit" name="btn-crear" class="subir" value="Subir imagen" style="color:#000; border-radius:10px; background-color:#edb612; border-color:#edb612;" />
                        </div>
                     </div>
                  </div>
               </div>
