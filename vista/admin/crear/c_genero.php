...
<?php
    ...
    if ($gen == "" ) {
        ...
        echo '<script>window.location="c_genero.php"</script>';

    }
    else {
        $insertsql3= $conex->prepare ("INSERT INTO genero(genero) VALUES ('$gen')");
        $insertsql3->execute();
                    ...
                    <div class="col-lg-8">
                        <div class="p-5">
                            <div class="text-center">
                                <br>
                                <h1 class="h4 text-gray-900 mb-4">Crear genero</h1>
                            </div>
                                <div class="form-group row">
    
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control" id="exampleFirstName" name="genero"
                                        onkeypress="return(sololetras(event));" maxlength="25"   placeholder="Genero" pattern="[A-Za-z].{1,25}" oninput="validarletras(this);" title="Solo se aceptan letras" required>
                                    </div>
                                </div>
