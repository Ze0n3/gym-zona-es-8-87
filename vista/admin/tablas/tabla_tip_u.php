...
$sql1 = $conex->prepare("SELECT * FROM tip_user
ORDER BY id_tip_user LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<?php
$sql = $conex->prepare("SELECT COUNT(*) FROM tip_user  ORDER BY id_tip_user");
$sql->execute();
...
echo "<center><a href='tabla_tip_u.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <br>
    <a class="btn btn success" style="margin-left: 90%; margin-top:0%;" href="../excel/excel_tip_usu.php">  
    ...
    <a  class="btn btn success" href="../imprimir/imp_tip_usu.php" style="margin-left: 88%; margin-top:1%;">  
    ...
    <table>
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <form method=" GET" action="../actu_datos.php" >
                        <input type="hidden" name="editar" value="<?= $usu['id_tip_user'] ?>">
    ...
    |<div class="text-center" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group me-2" role="group" aria-label="First group" aling>
                ...
                for ($i = 1; $i <= $total_paginas; $i++) {
                    echo "<a class='btn btn-primary'  href='tabla_tip_u.php?pagina=" . $i . "'> " . $i . " </a>";
                }
                echo "<a href='tabla_tip_u.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>"
                    . "</a></center>";
                ?>
            </div>
        </div>
