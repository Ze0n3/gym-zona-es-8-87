...
$sql1 = $conex->prepare("SELECT * FROM tip_servicio
ORDER BY id_tip_serv LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<?php
$sql = $conex->prepare("SELECT COUNT(*) FROM tip_servicio  ORDER BY id_tip_serv");
$sql->execute();
...
<head>
    ...
    <title>Lista de tipos de servicios</title>
...
<a class="btn btn success" href="../index.php" style="margin-left: -45%; margin-top:3%; position:absolute;">
    ...
    <a  class="btn btn success" href="../imprimir/imp_servicios.php" style="margin-left: 88%; margin-top:1%;">  
        ...
        |<div class="text-center" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2" role="group" aria-label="First group" aling>
                    ...
                    for ($i = 1; $i <= $total_paginas; $i++) {
                        echo "<a class='btn btn-primary'  href='tabla_tip_servicio.php?pagina=" . $i . "'> " . $i . " </a>";
                    }
                    echo "<a href='tabla_tip_servicio.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>"
                        . "</a></center>";
                    ?>
                </div>
            </div>
