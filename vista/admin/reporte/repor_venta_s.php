...
<head>
    ...
    <body>
    <a class="btn btn success" href="../tablas/tabla_venta_s.php" style="margin-left: 3.6%; margin-top:3%; position:absolute;">  
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-12 text-center mt-5">
                <form action="../excel/excel_venta_s.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    <div class="col">
                    ...
                    <div class="col" style="padding-top:20px;">
                      <span class="btn btn-dark mb-2" action="filtro_venta_s.php" id="filtro">Filtrar</span>
            ...
            <div class="table-responsive resultadoFiltro">
              ...
              $co = $daba ->conectar();
              session_start();
              $sqlTrabajadores = $co->prepare ('SELECT * FROM venta_serv ORDER BY fecha_ini ASC');
...
$("#filtro").on("click", function(e){ 
  ...
  if(f_ingreso !="" && f_fin !=""){
    $.post("filtro_venta_s.php", {f_ingreso, f_fin}, function (data) {
      $("#tableEmpleados").hide();
