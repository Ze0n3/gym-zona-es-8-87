          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-12 text-center mt-5">
                <form  action="../excel/excel_datos.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    <div class="col">
                    ...
                    <div class="col" style="padding-top:20px;">
                      <span class="btn btn-dark mb-2" action="filtro_datos.php" id="filtro">Filtrar</span>
            ...
            <div class="table-responsive resultadoFiltro">
              ...
              $co = $daba ->conectar();
              session_start();
              $sqlTrabajadores = $co->prepare ('SELECT * FROM datos ORDER BY fecha_regi ASC');
...
$("#filtro").on("click", function(e){ 
  ...
  if(f_ingreso !="" && f_fin !=""){
    $.post("filtro_datos.php", {f_ingreso, f_fin}, function (data) {
      $("#tableEmpleados").hide();
