...
<head>
    ...
    <title>Reporte de Medidas</title>
    ...
    <body>
    <a class="btn btn success" href="../tablas/tabla_medidas.php" style="margin-left: 3.6%; margin-top:3%; position:absolute;">  
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-12 text-center mt-5">
                <form action="../excel/excel_medidas.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    <div class="col">
                    ...
                    <div class="col" style="padding-top:20px;">
                      <span class="btn btn-dark mb-2" action="filtro_medidas.php" id="filtro">Filtrar</span>
            ...
            <div class="table-responsive resultadoFiltro">
              ...
              $co = $daba ->conectar();
              session_start();
              $sqlTrabajadores = $co->prepare ('SELECT * FROM medidas ORDER BY fecha_regi ASC');
              ...
              $i =1;
                ...
                <tbody>
                  ...
                  <td><?= $dataRow['doc_cliente'] ?></td>    
                <td><?= $dataRow['pecho'] ?></td>
                <td><?= $dataRow['cintura'] ?></td>
                <td><?= $dataRow['cadera'] ?></td>
                <td><?= $dataRow['brazo_izq'] ?></td>
                <td><?=$dataRow['brazo_der'] ?></td>
...
$("#filtro").on("click", function(e){ 
  ...
  if(f_ingreso !="" && f_fin !=""){
    $.post("filtro_medidas.php", {f_ingreso, f_fin}, function (data) {
      $("#tableEmpleados").hide();
