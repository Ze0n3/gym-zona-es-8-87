...
<body>
    ...
    <div class="container-fluid p-5">
        <div class="mb-5 text-center">
            <h5 class="text-primary text-uppercase">Contacta con nosotros</h5>
            <h1 class="display-3 text-uppercase mb-0">Ponerse en contacto</h1>
        </div>
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <p class="text-secondary mb-0">Av. Guabinal #67, Ibagué, Tolima</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <h5 class="text-uppercase text-primary">Envíanos un correo electrónico</h5>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                    ...
                    <h5 class="text-uppercase text-primary">Llámenos</h5>
        ...
        <div class="row g-0">
                ...
                <div class="bg-dark p-5">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control bg-light border-0 px-4" placeholder="Sujeto" style="height: 55px;">
                            </div>
                            <div class="col-12">
            ...
            <div class="col-lg-6">
                <iframe class="w-100"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d248.6146581980794!2d-75.19971648124258!3d4.441880941757224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e38c502cbb34de3%3A0xa1d62efce64fba93!2sAv.%20Guabinal%20%2367%2C%20Ibagu%C3%A9%2C%20Tolima!5e0!3m2!1ses!2sco!4v1681918581744!5m2!1ses!2sco" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </div>
        </div>
    </div>
    <!-- Contact End -->
